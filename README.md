...
If you'd like to train on an NVIDIA GPU using CUDA (this can be to about 15x
...
These two should be about the same order of magnitude. It's a little tricky to
